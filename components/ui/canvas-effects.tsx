...
function MiniNavbar() {
  ...
  const logoElement = (
    <img src="/gecko-logo.svg" alt="Gekko" className="w-6 h-6 opacity-90" />
  );
  ...
  const loginButtonElement = (
    <a
      ...
      className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#2B572A]/40 bg-[#2B572A]/8 text-[#4a8a49] rounded-full hover:border-[#2B572A]/70 hover:text-white transition-colors duration-200 w-full sm:w-auto text-center"
    >
      GitHub
    </a>
  );
  ...
  return (
    <header
      className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-20
                       ...
                       ${headerShapeClass}
                       border border-[#2B572A]/30 bg-[#0a0f0a]/70
